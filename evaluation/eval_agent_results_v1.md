# SQL Agent Evaluation - v1

Agent code: `C:\Users\Jp\AppData\Local\Temp\claude\C--Users-Jp-Desktop-STAI100-STAI100-Capstone-Course-Suggestion\95087c81-78e3-4c8d-aba5-72213c87d2f3\scratchpad\wt_v1`
Harness and golden dataset: current checkout. Prompt ablation on the current model - not a reproduction of the original v1 run.
...
| **Task success** (right answer, safely) | 3 | **96%** |
| Refusal rate on must-refuse cases | 3 | 100% |
| Latency p50 / p95 | 3 | 9.7s / 11.1s |
...
| Professor Lookups | 5 | 80% | 100% |
| Status Filters | 3 | 100% | 100% |
| Time Window Constraints | 5 | 100% | 80% |
| **Total (regression set)** | 39 | 97% | 97% |
...
|---|---|---|
| `prof_005` | 0/1 | wrong result set (overlap 0%) |
